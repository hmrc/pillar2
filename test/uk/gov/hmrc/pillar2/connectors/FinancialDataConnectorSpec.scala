...
//              .withStatus(404)
//              .withBody(
//                Json.stringify(Json.parse("""{"code": "NOT_FOUND", "reason": "The remote endpoint has indicated that no data can be found"}"""))
//              )
//          )
//      )
//
...
//      }
//
//      exception.getMessage must include("Financial data error: NOT_FOUND")
//    }
////    "must return status as BAD_REQUEST" in {
////      server.stubFor(
////        get(urlEqualTo(s"/enterprise/financial-data/ZPLR/$PlrReference/PLR"))
